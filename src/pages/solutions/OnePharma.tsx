  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        ...
        keywords="pharmacy management system, pharmacy software, hospital inventory ERP, batch tracking, medicine dispensing software, pharmacy POS, pharmacy billing"
