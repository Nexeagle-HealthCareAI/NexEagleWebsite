    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-tech-cyan/5 to-white">
      ...
      <main className="section-shell py-16 lg:py-20">
        <div className="max-w-4xl mx-auto text-center space-y-3">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-brand-navy">Leadership Team</h1>
          <p className="text-base md:text-lg text-brand-navy/70">Meet the people guiding easyHMS forward.</p>
        </div>
      </main>
      <Footer />
    </div>
